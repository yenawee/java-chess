...
- [x] command 입력
    - [x] move : 게임 진행
    - [x] status : 현재의 점수 상태 출력
    - [x] end : 진행중인 게임 종료
- [x] king 이 잡히거나 end 입력 시 게임 종료
...
- [x] 체스 게임방 id 번호를 입력하면 체스 게임방에 입장할 수 있다
- [x] new 를 입력하면 새로운 체스게임방이 생긴다
- [x] 현재 입장 가능한 체스게임방 id 를 보여준다
- [x] 체스게임방 id 를 입력받는다
    - [x] id 가 입장 가능한 체스게임방 숫자 범위를 넘어서거나 new 가 아니면 재입력
...
- [ ] chessroom (id, turn, player1, player2, state)
